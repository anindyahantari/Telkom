...
class Proyek extends Model
{
    ...
    protected $fillable = ['id_aspek','id_mitra','nik','judul','tahun','unit_kerja','saat_penggunaan','pemasukan_dokumen','ready_for_service','skema_bisnis','masa_kontrak','jenis_pelanggan','alamat_delivery'];
